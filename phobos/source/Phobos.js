...
/*enyo.kind({
	...
	handlers: {
		...
		onChangeSettings:"applyPreviewSettings", 
		onChangeRightPane: "changeRightPane", 
		onClose: "closeEditorPop", 
		onTabSizsChange: "tabSize"
	},
	create: function(){
		this.inherited(arguments);
	},
	getSettings: function(){
		return this.$.editorSettings.getSettings();
	},
	getPreviewSettings: function(){
		return this.$.editorSettings.getPreviewSettings();
	},
	...
	getSettingFromLS: function(){
		return this.$.editorSettings.getSettingFromLS();
	}
});*/

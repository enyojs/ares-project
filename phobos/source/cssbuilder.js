enyo.kind({
	...
	kind: "enyo.FittableRows", components: [
		...
		{name:"outputBox", kind: "enyo.Panels",	style: "width: 100%; height: 150px; ", classes: "enyo-selectable ares_cssbuilder_font",	allowHtml: true, Xstyle: "padding: 10px;", components: [
		...
		{kind: "Panels", fit:true, classes: "enyo-unselectable",components: [
			{kind: "enyo.Scroller", classes: "enyo-fit",components: [
				{classes: "ares_cssbuilder_pannel", style: " height: 250px", components: [
					...
					{kind: "onyx.RadioGroup", onActivate:"radioActivated", components:[
						{content:"background", classes: "ares_cssbuilder_RadioGroup"},
						{content:"Font color", classes: "ares_cssbuilder_RadioGroup"},
						{content:"Border color", classes: "ares_cssbuilder_RadioGroup"}
					]}
				]},

				{classes: "ares_cssbuilder_pannel", style: " height: 350px", components: [
					{name: "fonts", classes: "ares_cssbuilder_border", content:"Fonts "},
					{kind: "onyx.RadioGroup",
					onActivate:"fontActivated",components:[
						{tag: "br"},
						{content:"Serif", style: "font-family: Serif;", classes: "ares_cssbuilder_RadioGroup"},
						{content:"Sans-serif", style: "font-family: Sans-serif;", classes: "ares_cssbuilder_RadioGroup"},

						{content:"Helvetica  ", style: "font-family: Helvetica;", classes: "ares_cssbuilder_RadioGroup"},
						{content:"Monospace", style: "font-family: Monospace;", classes: "ares_cssbuilder_RadioGroup"},

						{content:" Lucida Sans Unicode ", style: "font-family: Lucida Sans Unicode;", classes: "ares_cssbuilder_RadioGroup"},
						{content:"Times New Roman  ", style: "font-family: Times New Roman;", classes: "ares_cssbuilder_RadioGroup"},

						{content:" Courier New ", style: "font-family: Courier New;", classes: "ares_cssbuilder_RadioGroup"},
						{content:" Arial ", style: "font-family: Arial;", classes: "ares_cssbuilder_RadioGroup"}
					]},

					{classes: "onyx-toolbar-inline", components: [
						{content: "Font Size", classes: "ares_cssbuilder_picker"},
					...
					{style: "height: 5px"},
					{kind: "onyx.Button", classes: "ares_cssbuilder_button ", content: "Text Shadow", ontap: "textshadow"}
				]},

				{classes: "ares_cssbuilder_pannel", style: " height: 200px", components: [
					{name: "imageborder", classes: "ares_cssbuilder_border", content:"Border/Margin..."},

					{kind: "enyo.FittableColumns", components: [
						{classes: "onyx-toolbar-inline fonts", components: [
							{content: "Height", classes: "ares_cssbuilder_picker"},
							{kind: "onyx.PickerDecorator", components: [
						...
						{classes: "onyx-toolbar-inline", components: [
							{content: "Width", classes: "ares_cssbuilder_picker"},
							{kind: "onyx.PickerDecorator", components: [
					...
					{kind: "enyo.FittableColumns", components: [
						{classes: "onyx-toolbar-inline", components: [
							{content: "Margin Size", classes: "ares_cssbuilder_picker"},
							{kind: "onyx.PickerDecorator", components: [
						...
						{classes: "onyx-toolbar-inline", components: [
							{content: "Border Size", classes: "ares_cssbuilder_picker"},
							{kind: "onyx.PickerDecorator", components: [
								{style: "min-width: 40px; font-size: 10px;"},
					...
					{kind: "enyo.FittableColumns", classes: "ares_cssbuilder_font", components: [
						{classes: "onyx-toolbar-inline", components: [
							{content: "Radius", classes: "ares_cssbuilder_picker"},
							{kind: "onyx.PickerDecorator", components: [
								{style: "min-width: 40px; font-size: 10px;"},
						...
						{classes: "onyx-toolbar-inline", components: [
							{content: "Padding", classes: "ares_cssbuilder_picker"},
							{kind: "onyx.PickerDecorator", components: [
								{style: "min-width: 40px; font-size: 10px;"},
					...
					{kind: "onyx.Button", classes: "ares_cssbuilder_button ", content: "Box Shadow", ontap: "boxshadow"}
				]},

				{classes: "ares_cssbuilder_pannel ", style: " height: 200px", components: [
					{name: "border", classes: "ares_cssbuilder_border", content: "Images..."},
					{style: "height: 5px"},
					{kind: "onyx.Input", name: "imageInput", placeholder: "Enter image url:...", onchange: "imageInput"},

					{kind: "enyo.FittableColumns", classes: "ares_cssbuilder_font", components: [
						{style: "height: 50px"},
						{kind: "enyo.FittableRows", style: "witdh: 75px;", classes: "ares_cssbuilder_fonts",components: [
							{style: "height: 15px"},
							{classes: "ares_cssbuilder_fonts", content: "Repeat H"},
					...
					{kind: "enyo.FittableRows", classes: "ares_cssbuilder_font", components: [
						{style: "height: 5px"},
						{content: "No-Repeat"},
		...
		{name: "popup", kind: "onyx.Popup", classes: "ares_cssbuilder_popup", centered: true, modal: true, floating: true, components: [
			{ kind: "onyx.Toolbar", layoutKind: "FittableColumnsLayout", Xstyle: "margin: 10px;", components: [
				{name: "shadowBar", content: "Text Shadow"}
			]},

			{classes: "onyx-toolbar-inline", components: [
				{content: "Horizontal shadow", classes: "ares_cssbuilder_picker"},
				{kind: "onyx.PickerDecorator", components: [
					{style: "min-width: 40px; font-size: 10px;"},
			...
			{classes: "onyx-toolbar-inline", components: [
				{content: "Vertical shadow--- ", classes: "ares_cssbuilder_picker"},
				{kind: "onyx.PickerDecorator", components: [
					{style: "min-width: 40px; font-size: 10px;"},
			...
			{classes: "onyx-toolbar-inline", components: [
				{content: "Blur distance-------", classes: "ares_cssbuilder_picker"},
				{kind: "onyx.PickerDecorator", components: [
					{style: "min-width: 40px; font-size: 10px;"},
					{name: "TextShadowB", kind: "onyx.Picker",onSelect: "textshadowB"}
				]}
			]},
			{name:"textoutputBox", kind: "enyo.Panels", classes: "ares_cssbuilder_outputbox2",	allowHtml: true, Xstyle: "padding: 10px;", components: [
			...
			{kind: "enyo.FittableRows", components: [
				...
				{style: "height: 5px"},
				{kind: "onyx.Button", content: "Close", classes: "ares_cssbuilder_button ", ontap: "closePopup"}
			]}
		]},

		{name: "boxShadowPopup", kind: "onyx.Popup", classes: "ares_cssbuilder_popup", centered: true, modal: true, floating: true, components: [
			{ kind: "onyx.Toolbar", layoutKind: "FittableColumnsLayout", Xstyle: "margin: 10px;", components: [
			...
			{name:"outputBox2", kind: "enyo.Panels", classes: "ares_cssbuilder_outputbox2",	allowHtml: true, Xstyle: "padding: 10px;", components: [

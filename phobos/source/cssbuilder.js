...
enyo.kind({
    ...
    },
    {
        ...
        classes: "enyo-selectable css_builder_font",
        allowHtml: true,
        Xstyle: "padding: 10px;",
        components: [{
            name: "bg",
        ...
        components: [{
            ...
            components: [{
...

                {
                    ...
                    components: [{
                        content: "background",
                        classes: "css_builder_RadioGroup"
                    },
                    {
                        content: "Font color",
                        classes: "css_builder_RadioGroup"
    ...
    {
        name: "textShadowPopup",
        kind: "onyx.Popup",
        classes: "css_builder_popup",
        centered: true,
        modal: true,
        floating: true,
        components: [{
        ...
        },
        {
            name: "textoutputBox",
            kind: "enyo.Panels",
            classes: "css_builder_outputbox2",
            allowHtml: true,
            Xstyle: "padding: 10px;",
            components: [{
    ...
    create: function() {
        ...
        for (var i = 0; i < 50; i++) {
            ...
            this.$.borderSizePicker.createComponent({
                content: i,
                active: !i
            });
            this.$.marginSizePicker.createComponent({
                content: i,
                active: !i
            });
            this.$.Radius.createComponent({
                content: i,
                active: !i
            });
            this.$.Padding.createComponent({
                content: i,
                active: !i
            });
            this.$.TextShadowB.createComponent({
                content: i,
                active: !i
            });
            this.$.BoxShadowB.createComponent({
                content: i,
                active: !i
            });
        }
        ...
        for (var j = 5; j < 2000; j += 5) {
            this.$.heightSizePicker.createComponent({
                content: j,
                active: !j
            });
            this.$.widthSizePicker.createComponent({
                content: j,
                active: !j
            });
        }
        for (var k = -25; k < 25; k++) {
            this.$.TextShadowH.createComponent({
                content: k,
                active: !k
            });
            this.$.TextShadowV.createComponent({
                content: k,
                active: !k
            });
            this.$.BoxShadowH.createComponent({
                content: k,
                active: !k
            });
            this.$.BoxShadowV.createComponent({
                content: k,
                active: !k
            });
        }

enyo.kind({
	...
	components: [
		...
		{kind: "FittableColumns", name: "groupbox7", components: [
				{kind: "Control", content: "Programmable buttons Alt F1 to Alt F12", name: "control"},
				{kind: "Control", tag: "br", name: "control2"},
		...
		{kind: "onyx.Popup", modal: true, floating: true, centered: true, canGenerate: false, name: "modalPopup", components: [
				{kind: "Control", classes: "onyx-toolbar-inline", name: "control3", components: [

enyo.kind({
	...
	copyClick: function(inSender, inEvent) {
		this.$.nameCopyPopup.setType("foo.js");
		this.$.nameCopyPopup.setPath("/");
	...
	renameClick: function(inSender, inEvent) {
		this.$.renamePopup.setType("foo.js");
		this.$.renamePopup.setPath("/");
	...
	deleteClick: function(inSender, inEvent) {
		this.$.deletePopup.setFileName("foo.js");
		this.$.deletePopup.setPath("/");

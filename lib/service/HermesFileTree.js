enyo.kind({
	...
	components: [
		{kind: "onyx.Toolbar", defaultKind: "onyx.IconButton", components: [
			...
			{name: "newFolder", src: "$harmonia/images/folder_new.png", hint: "New Folder...", onclick: "newFolderClick"},
			{name: "newFile", src: "$harmonia/images/document_new.png", hint: "New...", onclick: "newFileClick"},

enyo.kind({
	...
	components: [
		...
		{kind: "Scroller", fit: true, components: [
			...
			{kind: "Node", classes: "enyo-unselectable", showing: false, file: {id: ".", name: "server"}, content: "server", icon: "$service/images/antenna.png", expandable: true, expanded: true, onExpand: "nodeExpand", onNodeTap: "nodeTap"}
		]},

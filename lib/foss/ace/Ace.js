enyo.kind({
	...
	addKeyBindings: function() {
		...
		commands.addCommand({
			name: "f1",
			bindKey: {win: "Alt-F1", mac: "Command-F1"},
		...
		commands.addCommand({
			name: "f2",
			bindKey: {win: "Alt-F2", mac: "Command-F2"},
		...
		commands.addCommand({
			name: "f3",
			bindKey: {win: "Alt-F3", mac: "Command-F3"},
		...
		commands.addCommand({
			name: "f4",
			bindKey: {win: "Alt-F4", mac: "Command-F4"},
		...
		commands.addCommand({
			name: "f5",
			bindKey: {win: "Alt-F5", mac: "Command-F5"},
		...
		commands.addCommand({
			name: "f6",
			bindKey: {win: "Alt-F6", mac: "Command-F6"},
		...
		commands.addCommand({
			name: "f7",
			bindKey: {win: "Alt-F7", mac: "Command-F7"},
		...
		commands.addCommand({
			name: "f8",
			bindKey: {win: "Alt-F8", mac: "Command-F8"},
		...
		commands.addCommand({
			name: "f9",
			bindKey: {win: "Alt-F9", mac: "Command-F9"},
		...
		commands.addCommand({
			name: "f2",
			bindKey: {win: "Alt-F10", mac: "Command-F10"},
		...
		commands.addCommand({
			name: "f11",
			bindKey: {win: "Alt-F11", mac: "Command-F11"},
		...
		commands.addCommand({
			name: "f12",
			bindKey: {win: "Alt-F12", mac: "Command-F12"},

...
track: function(a) {
this.lastDx = this.dx, this.lastDy = this.dy, this.dx = a.clientX - this.px0, this.dy = a.clientY - this.py0, this.xDirection = this.calcDirection(this.dx - this.lastDx), this.yDirection = this.calcDirection(this.dy - this.lastDy);
...
var a = this.scrollNode, b = this.container.hasNode(), c = {
...
scrollMathStart: function(a) {
this.inherited(arguments), this.scrollStarting = !0;
},
scrollMathScroll: function(a) {
this.scrollLeft = -a.x, this.scrollTop = -a.y, this.isScrolling() && (this.scrollStarting && this.scrollNode && (this.scrollStarting = !1, this.scrollNode.scrollTop = this.scrollNode.scrollLeft = 0), this.effectScroll(-this.scrollLeft, -this.scrollTop), this.thumb && this.updateThumbs());
},
effectScroll: function(a, b) {
...
effectScrollStop: function() {
var a = "0,0" + (this.accel ? ",0" : ""), b = this.$.scrollMath, c = this._getScrollBounds(), d = c.maxTop + b.bottomBoundary || c.maxLeft + b.rightBoundary;
